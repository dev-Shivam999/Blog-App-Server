...
var Post_1 = require("../controllers/blog/Post");
var showPost_1 = require("../controllers/user/showPost");
var update_1 = require("../controllers/blog/update");
var sign_1 = require("../controllers/user/sign");
var All_1 = require("../controllers/blog/All");
...
exports.routes.get('/AllUser', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, __1.client.bloger.findMany({
                    where: {
                        id: 1
                    },
                    select: {
